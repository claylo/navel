...
| **/design-consent** | Grant Claude agent access to your Design projects | 2.1.199 | available | **no** |
| /design-login | Authorize design-system access for /design-sync with your... | 2.1.178 | available | yes |
| **/design-revoke** | Revoke Claude agent access to your Design projects | 2.1.199 | available | **no** |
...
| **/setup-cowork** | — | 2.1.199 | available | **no** |
...
| ANTHROPIC_DEFAULT_OPUS_MODEL_DESCRIPTION | 2.1.84 | yes |
| ANTHROPIC_DEFAULT_OPUS_MODEL_NAME | 2.1.84 | yes |
...
| **ANTHROPIC_ORGANIZATION_ID** | 2.1.116 | **no** |
| **ANTHROPIC_PROFILE** | 2.1.116 | **no** |
...
| **BUN_ENV** | 2.1.113 | **no** |
| **BUN_FEEDBACK_URL** | 2.1.113 | **no** |
| **BUN_INSPECT_NOTIFY** | 2.1.113 | **no** |
| **BUN_INSTALL** | 0.2.33 | **no** |
| **BUN_JS_DEBUG** | 2.1.113 | **no** |
| C | 0.2.33 | yes |
| **C9_PID** | 2.1.110 | **no** |
| **C9_USER** | 2.1.110 | **no** |
...
| **CLAUDE_CODE_ENABLE_XAA** | 2.1.83 | **no** |
| CLAUDE_CODE_ENHANCED_TELEMETRY_BETA | 2.1.7 | yes |
...
| CLAUDE_CODE_IDE_SKIP_VALID_CHECK | 1.0.4 | yes |
...
| CLAUDE_CODE_OAUTH_TOKEN | 1.0.44 | yes |
...
| **CLAUDE_CODE_RATE_LIMIT_TIER** | 2.1.117 | **no** |
...
| CLAUDE_CODE_REMOTE_SESSION_ID | 2.0.52 | yes |
| **CLAUDE_CODE_REPL** | 2.1.89 | **no** |
...
| CLAUDE_CODE_SKIP_MANTLE_AUTH | 2.1.94 | yes |
...
| **DAYTONA_WS_ID** | 2.1.110 | **no** |
| DEBUG | 0.2.33 | yes |
| **DEBUG_AUTH** | 0.2.33 | **no** |
| **DEBUG_CLAUDE_AGENT_SDK** | 2.1.119 | **no** |
...
| ENABLE_ENHANCED_TELEMETRY_BETA | 2.0.18 | yes |
| **ENABLE_MCP_LARGE_OUTPUT_FILES** | 2.0.71 | **no** |
| ENABLE_PROMPT_CACHING_1H | 2.1.108 | yes |
| ENABLE_PROMPT_CACHING_1H_BEDROCK | 2.1.42 | yes |
| ENABLE_TOOL_SEARCH | 2.0.70 | yes |
| FALLBACK_FOR_ALL_PRIMARY_MODELS | 2.0.35 | yes |
...
| GITHUB_TOKEN | 2.1.6 | yes |
| **GITHUB_WORKSPACE** | 2.1.105 | **no** |
| **GITLAB_CI** | 2.0.15 | **no** |
...
| **GOOGLE_CLOUD_WORKSTATIONS** | 2.1.119 | **no** |
...
| MCP_CONNECTION_NONBLOCKING | 2.1.2 | yes |
...
| 2.1.117 | — | +fork | +4, -1 |
| 2.1.116 | +UserPromptExpansion | +mode | +8 |
| 2.1.113 | — | +fewer-permission-prompts | +15, -10 |
| 2.1.111 | — | +less-permission-prompts | +5 |
| 2.1.110 | — | +focus, +tui | +15 |
| 2.1.108 | — | — | +4 |
| 2.1.105 | — | +recap | +9, -5 |
| 2.1.101 | — | +loops, +update | +2 |
| 2.1.98 | — | +setup-vertex | +10 |
| 2.1.97 | — | +dream | +3, -5 |
| 2.1.94 | — | +autofix-pr, +team-onboarding | +6 |
| 2.1.92 | — | +setup-bedrock, +stop-hook, +teleport | +4, -2 |
| 2.1.91 | — | +ultraplan | -1 |
| 2.1.90 | — | +powerup, +toggle-memory | +6, -1 |
| 2.1.89 | +PermissionDenied | +autocompact, +buddy | +12, -3 |
| 2.1.86 | — | — | +2 |
| 2.1.85 | — | — | +7 |
| 2.1.84 | +TaskCreated | — | +13, -1 |
| 2.1.83 | +CwdChanged, +FileChanged | +advisor, +ultraplan, +ultrareview, +version | +11, -2 |
| 2.1.81 | — | — | +6 |
| 2.1.80 | — | +schedule | +2 |
